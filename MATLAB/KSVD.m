% Function that implements dictionary learning via KSVD
% Code is based on the article "K-SVD: An Algorithm for Designing 
% Overcomplete Dictionaries for Sparse Representation" by Aharon et al.
% https://doi.org/10.1109/TSP.2006.881199
% Author: Carlos Loza
% carlos85loza@gmail.com

function [D, elap_time] = KSVD(Y, K, L, n_it, sp_cod_m, D_ini)
% INPUTS:
